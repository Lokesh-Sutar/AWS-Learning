...
| `apt install nginx` (Debian/Ubuntu) | `apt install apache` (Debian/Ubuntu)  |
...
| **Nginx**               | **Apache**                                |
| ----------------------- | ----------------------------------------- |
| `systemctl start nginx` | `systemctl start apache` (Debian/Ubuntu)  |
|                         | `systemctl start httpd` (RHEL/Amazon)     |

### Check Status
| **Nginx**                | **Apache**                                 |
| ------------------------ | ------------------------------------------ |
| `systemctl status nginx` | `systemctl status apache` (Debian/Ubuntu) |
...
| **Nginx**    | **Apache**                     |
| ------------ | ------------------------------ |
| `/etc/nginx` | `/etc/apache` (Debian/Ubuntu) |
